...
$host     = '8i194v.myd.infomaniak.com';     // Hostserver, auf dem die DB läuft.
// «localhost» bedeutet: die selbe Serveradresse, auf dem auch die Seiten gespeichert sind

$dbname   = '8i194v_im3_db';   // Name der Datenbank
$username = '8i194v_im3_user';   // Benutzername für die DB
$password = 'F_2da-.iU.@yV_nUu@jT';   // Passwort für die DB
